...
public final class Messages {
	public static String invalidEmail = "Email adress is invalid";
	public static String canNotNull = " is cannot be empty!";
	...
	public static String employerVerifiedByAdmin = "Employer verified.";
	public static String cityAddedSuccess = "City added successfuly";
	public static String listedData = "Data listed";
	public static String advertiseAddedSuccessfully = "Job advertise added successfuly";
	public static String employerNotActive = "Employer isn't active.";
}
